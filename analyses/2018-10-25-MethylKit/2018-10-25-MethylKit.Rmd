...
DMLbarplot <- barplot(as.matrix(t(DMLchrCounts$DMLbyChrLength)),
                      axes = FALSE, 
...
axis(side = 2, line = 1.5, at = seq(0, 1.4, by = 0.2), las = 2, col = "grey80", cex.axis = 1.2) #Add y-axis for DML counts
mtext(side = 2, "DML/Chromosome Length (Mb)", line = 5, cex = 1.5) #Add y-axis label for DML counts
