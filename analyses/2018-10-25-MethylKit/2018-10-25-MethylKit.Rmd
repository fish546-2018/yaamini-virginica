...
```{r}
DMLchrCounts <-as.data.frame(table(differentialMethylationStatsFilteredCov5Destrand$chr)) #Count the number of DML/chromosome
colnames(DMLchrCounts) <- c("chr", "frequency") #Rename columns
head(DMLchrCounts)
```
