...
axis(side = 2, line = 1.5, at = seq(0, 7e-05, by = 1e-05), las = 2, col = "grey80", cex.axis = 1.2) #Add y-axis for DML counts
mtext(side = 2, "DML/CpG in Chromosome", line = 5, cex = 1.5) #Add y-axis label for DML counts
