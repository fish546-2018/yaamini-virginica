...
```{r}
parentGOMFCondensed <- unique(merge(x = DMLGenbank, y = parentGOMF, by = "Genbank")) #Merge condensed DML with parentGOMF
...
```{r}
parentGOMFCondensedHyper <- unique(merge(x = condensedDMLHyper, y = parentGOMF, by = "Genbank")) #Merge condensed DML with parentGOMF
...
```{r}
parentGOMFCondensedHypo <- unique(merge(x = condensedDMLHypo, y = parentGOMF, by = "Genbank")) #Merge condensed DML with parentGOMF
