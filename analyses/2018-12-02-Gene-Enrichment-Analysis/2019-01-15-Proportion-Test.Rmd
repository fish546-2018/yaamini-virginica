...
barplot(t(t(allCpGCategories)),
        ...
        ylim = c(0,100),
        col = c("grey20", "grey40", "grey60", "grey80", "grey100")) #Create a stacked barplot. Use axes = FALSE to remove the y-axis and names.arg to set labels on the x-axis.
