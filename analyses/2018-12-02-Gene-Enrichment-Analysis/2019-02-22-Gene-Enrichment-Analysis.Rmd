...
The final thing I want to do is combine the number of "mixed" hyper/hypomethylated DML categories to simplify any downstream figures.
...
```{r}
#Stacked barplots with only hyper, mixed, and hypo DML types
