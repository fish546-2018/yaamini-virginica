...
layout(mat = plotMatrix, width = c(2, 2, 1.2, 2)) #Create a layout based on plotMatrix. The first and second plots (first column) should be wider.
...
mtext(side = 1, "Number of DML", line = 7, cex = 1.3) #Add x-axis label
...
barplot(t(t(multipleDMLTotals)),
        axes = FALSE, 
        names.arg = c("Hyper", "Hypo"),
        cex.names = 1.5,
        ylim = c(0,107),
        col = plotColors[2:5]) #Create a stacked barplot. Use axes = FALSE to remove the y-axis and names.arg to set labels on the x-axis.
axis(side = 2, at = seq(0, 100, by = 10), las = 2, col = "grey80", cex.axis = 1.2)
mtext(side = 2, "DML (%)", line = 4, cex = 1.3) #Add y-axis label
mtext(side = 3, line = -2, adj = 0, text = "  c.") #Add figure label
