...
I will subset significant uncorrected p-values since it's an exploratory study.
...
```{r}
write.csv(uncorrSigKWTestResults, "2019-08-14-DMG-KW-Test-Results-Uncorrected-Sig.csv", quote = FALSE, row.names = FALSE) #Save file
```
...
I will subet uncorrected significant p-values since this is an exploratory study.
...
```{r}
write.csv(uncorrSigKWTestResultsDML, "2019-08-14-DMG-KW-Test-Results-DMLOnly-Uncorrected-Sig.csv", quote = FALSE, row.names = FALSE) #Save file
```
