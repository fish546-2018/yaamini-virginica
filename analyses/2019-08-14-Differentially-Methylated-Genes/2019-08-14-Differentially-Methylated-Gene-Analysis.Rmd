...
```{r}
parentGOBPGenesSig <- unique(merge(x = parentGOBPGenes, y = uncorrSigGenes, by = "Genbank", all.y = TRUE)) #Merge parent GOslim terms with annotated DMG. Keep all annotated genes that do not have matching GO-MWU information. Remove any merging artifacts.
