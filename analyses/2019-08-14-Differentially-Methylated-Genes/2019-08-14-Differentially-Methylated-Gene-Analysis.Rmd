...
# Calculate median percent methylation
...
```{r}
#Use a full_join to merge ambient and treatment percent methylation information so all geneIDs are present.
fullPercentMeth <- full_join(x = zr2096_1_PercentMeth, y = zr2096_2_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_3_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_4_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_5_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_6_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_7_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_8_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_9_PercentMeth, by = "geneID")
fullPercentMeth <- full_join(x = fullPercentMeth, y = zr2096_10_PercentMeth, by = "geneID")
length(fullPercentMeth$geneID) #Number of gene IDs in combined dataset.
head(fullPercentMeth) #Confirm full_join
```
...
zr2096_2_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_2_PercentMethFull$geneID))
zr2096_3_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_3_PercentMethFull$geneID))
zr2096_4_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_4_PercentMethFull$geneID))
zr2096_5_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_5_PercentMethFull$geneID))
zr2096_6_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_6_PercentMethFull$geneID))
zr2096_7_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_7_PercentMethFull$geneID))
zr2096_8_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_8_PercentMethFull$geneID))
zr2096_9_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_9_PercentMethFull$geneID))
zr2096_10_PercentMethFull$sampleNumber <- rep("sample_1", times = length(zr2096_10_PercentMethFull$geneID))
...
I want to do a t-test, so I should first check normality and variance assumptions.

### Check normality
`
```{r}
#Check normality
hist(ambientPercentMethFull$percentMeth) #Ambient samples
hist(treatmentPercentMethFull$percentMeth) #Treatment samples
```

These clearly aren't normal distributions. I need to do some corrections to deal with the left-skewed distributions.

#### Log transformation

```{r}
#Perform log transformation
ambientPercentMethFull$logPercentMeth <- log(ambientPercentMethFull$percentMeth) #Ambient samples
treatmentPercentMethFull$logPercentMeth <- log(treatmentPercentMethFull$percentMeth) #Treatment samples
```

```{r}
#Check normality
hist(ambientPercentMethFull$logPercentMeth) #Ambient samples
hist(treatmentPercentMethFull$logPercentMeth) #Treatment samples
```
...
ambientPercentMethFull$sqrtPercentMeth <- sqrt(ambientPercentMethFull$percentMeth) #Ambient samples
treatmentPercentMethFull$sqrtPercentMeth <- sqrt(treatmentPercentMethFull$percentMeth) #Treatment samples
```

```{r}
#Check normality
hist(ambientPercentMethFull$sqrtPercentMeth) #Ambient samples
hist(treatmentPercentMethFull$sqrtPercentMeth) #Treatment samples
```

```{r}
#Perform cube root transformation
ambientPercentMethFull$crtPercentMeth <- (ambientPercentMethFull$percentMeth)^(1/3) #Ambient samples
treatmentPercentMethFull$crtPercentMeth <- log(treatmentPercentMethFull$percentMeth)^(1/3) #Treatment samples
```

```{r}
#Check normality
hist(ambientPercentMethFull$crtPercentMeth) #Ambient samples
hist(treatmentPercentMethFull$crtPercentMeth) #Treatment samples
```
...
```{r}
temp <- kruskal.test(treatmentPercentMethFull$percentMeth ~ ambientPercentMethFull$percentMeth)
temp$p.value
```
