...
```{r}
CVGOslim <- read.delim("Blastquery-GOslim.sorted", sep = "\t", header = FALSE) #Import data with Genbank ID and GOslim terms
...
```{r}
sum(is.na(parentGOBPGenesSigGOslim$GOslim)) #Count how many DMG do not have GOslim entries. 199/223 do not have GO-MWU entries.
```
