...
```{bash}
head 2020-02-25-promoterOverlap-percentMeth-Medians.txt
```
...
```{bash}
head 2020-02-25-UTROverlap-percentMeth-Medians.txt
```
...
```{bash}
head 2020-02-25-exonOverlap-percentMeth-Medians.txt
```
...
```{bash}
head 2020-02-25-intronOverlap-percentMeth-Medians.txt
```
...
```{bash}
head 2020-02-25-TEOverlap-percentMeth-Medians.txt
```
...
```{bash}
head 2020-02-25-intergenicOverlap-percentMeth-Medians.txt
```
